    ...
    <div className="border-[2px] rounded-xl p-5">
      ...
      <div className="flex items-center gap-5 text-[#282828CC] text-[16px]">
        <p className="flex items-center gap-1">
          <IoMdTime className="text-xl"></IoMdTime>{time}
        </p>
        <p className="flex items-center gap-1">
          <AiOutlineFire className="text-xl"></AiOutlineFire>{calories}
        </p>
      </div>
      <button onClick={()=>handleBtn(allCart)} className="text-[#150B2B] px-5  py-2 rounded-[50px] bg-[#0BE58A] mt-4 text-[18px] font-medium">
        Want to Cook
      </button>
    </div>
  );
